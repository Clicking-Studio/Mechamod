...
loader.load(stlUrl, (geometry)=>{
    ...
    loader.load("../dist/assets/Snake_KeyCap_VI_STL_001.stl", (geometry)=>{
        ...
        objects.at(-1).position.setZ(hiddenZoneZ);
        loader.load("../dist/assets/model3.stl", (geometry)=>{
            const material = new _three.MeshNormalMaterial();
            objects.push(new _three.Mesh(geometry, material));
            scene.add(objects.at(-1));
            objects.at(-1).position.setZ(hiddenZoneZ);
            loader.load("../dist/assets/model4.stl", (geometry)=>{
                const material = new _three.MeshNormalMaterial();
                objects.push(new _three.Mesh(geometry, material));
                scene.add(objects.at(-1));
                objects.at(-1).position.setZ(hiddenZoneZ);
...
function slide(objInd, dir, startRot, endRot, easing) {
    ...
    const tween = new _tweenEsmJs.Tween({
        ...
        shadow1.style.transform = "translateX(" + coords.shadowX * dir + "px)";
        shadow2.style.transform = "translateX(" + (coords.shadowX - window.innerWidth / 1.3) * dir + "px)";
...
},{"three":"ktPTu","./modules/OrbitControls.js":"9RT6q","./modules/STLLoader.js":"2BpWB","./modules/tween.esm.js":"3ax19"}]},["47Zjz","8ZNvh"], "8ZNvh", "parcelRequire772b")
